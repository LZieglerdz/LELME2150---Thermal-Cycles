...
for gr in GROUPS:
    try:
        ...
        eta_is_HP = 0.92            
        eta_is_LP = 0.90           
        options = comb, T_ref, p_ref, T_1g, p_1g, T_3g, r, eta_pi_c, eta_pi_t, k_cc, k_mec, p_3, p_5, T_5, p_6, T_6, p_7, x_7, T_pinch_approach, T_pinch, eta_pump, eta_is_HP, eta_is_LP
        display = True
        try:
            ...
            (eta_cyclen,eta_toten,eta_cyclex,eta_totex,eta_gen,eta_gex,eta_combex,eta_chimnex,eta_condex,eta_transex,eta_rotex) = ETA
            ...
            (fig_pie_en,fig_pie_ex,fig_heat_exchange,fig_Ts_diagram,fig_hs_diagram) = FIG
            (p,T,h,s,e,x) = DAT
